    ...
    this.innerHTML = `
      <article>
        <header class="d-flex gap-3">
          <img src="https://dummyimage.com/600x400/947894/fff" class="avatar-img rounded-circle" alt="">
          <div>
            ...
            <p>
              ...
              <span class="text-muted">on 19 November 2023</span>
            </p>
          </div>
        </header>
        <p>I was actually looking forward to watch this movie. Unfortunately I have to say I was rather disappointed when the movie came to an end.
          ...
          That is not what I was expecting and it is definitely not what I wanted to watch.</p>
      </article>
      <hr>
    `;
  }
